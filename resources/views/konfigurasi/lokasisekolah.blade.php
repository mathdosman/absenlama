                ...
                <form action="/konfigurasi/updatelokasi" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <input type="text" value="{{$lok_sekolah->lokasi_sekolah}}" name="lokasi_sekolah" id="lokasi_sekolah" class="form-control" placeholder="Lokasi Sekolah">
                                    </div>
                                    <div class="input-icon mb-3">
                                    <span class="input-icon-addon">
                                      <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                                    ...
                                    <input type="text" value="{{$lok_sekolah->radius}}" name="radiusx" id="radiusx" class="form-control" placeholder="Radius">
                                    </div>
