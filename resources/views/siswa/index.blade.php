        ...
        <div class="row">
                <div class="card">
                    ...
                    @endif
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                <a href="#" class="btn btn-primary" id="tambahsiswa">
                    ...
                    <tbody>
                        @foreach ($siswa as $d)
                        @php
                            $path = Storage::url('uploads/datasiswa/'.$d->foto);
                        @endphp
                        <tr class="text-center" >
          ...
          <form action="/siswa/store" method="POST" id="frmsiswa" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-12">
                                ...
                                <input type="text" value="" name="nisn" id="nisn" class="form-control" placeholder="NISN" maxlength="10">
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        ...
                                        <option selected="" >Pilih Kegiatan (opsional)</option>
                                                    @foreach ($kegiatan as $d)
                                                    <option {{Request('kode_kegiatan') == $d -> kode_kegiatan ? 'selected' : '' }} value="{{$d -> kode_kegiatan }}">{{ $d -> nama_kegiatan }}</option>
                                                    @endforeach
                                      </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12">
                                        <select class="form-select" id="jabatan" name="jabatan" aria-label="Floating label select example">
                                ...
                                <input type="number" value="" name="no_hp" id="no_hp" class="form-control" placeholder="Nomor Hp">
                                </div>
                                <!-- ============ -->
                                <div class="mb-3">
